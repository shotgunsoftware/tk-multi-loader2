...
class MaterialsAppDialog(QtGui.QWidget):
    ...
    def __setup_ui(self):
        ...
        # Entity data type
        # entity_type_label = QtGui.QLabel("", self)
...
#     visible = index.data(MaterialsModel.FILE_ITEM_ROLE) is None
#     status = index.data(MaterialsModel.STATUS_ROLE)
#     status_icon = MaterialsModel.get_status_icon(status)
...
#     visible = index.data(MaterialsModel.FILE_ITEM_ROLE) is not None
#     status = index.data(MaterialsModel.STATUS_ROLE)
#     status_icon = MaterialsModel.get_status_icon(status)
