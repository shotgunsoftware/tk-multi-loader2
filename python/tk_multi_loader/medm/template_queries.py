...
def get_template_pipeline_steps(project: FlowProject) -> list[FlowAsset]:
...
def get_templates(pipeline_step: FlowAsset) -> list[FlowAsset]:
...
def find_template_pipeline_step(
    project: FlowProject, pipeline_step_name: str
) -> Optional[FlowAsset]:
