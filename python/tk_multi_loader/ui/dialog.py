...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy1.setHeightForWidth(self.left_area_widget.sizePolicy().hasHeightForWidth())
        self.left_area_widget.setSizePolicy(sizePolicy1)
...
"          }")
        ...
        sizePolicy3.setHeightForWidth(self.check_all.sizePolicy().hasHeightForWidth())
        self.check_all.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.check_none.sizePolicy().hasHeightForWidth())
        self.check_none.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.middle_area_widget.sizePolicy().hasHeightForWidth())
        self.middle_area_widget.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.entity_breadcrumbs.sizePolicy().hasHeightForWidth())
        self.entity_breadcrumbs.setSizePolicy(sizePolicy5)
        ...
        self.thumbnail_mode.setAutoRaise(True)
        ...
        self.list_mode.setAutoRaise(True)
        ...
        self.search_publishes.setAutoRaise(True)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/res/icon_filter.png", QSize(), QIcon.Normal, QIcon.Off)
        self.filter_menu_btn.setIcon(icon4)
        self.filter_menu_btn.setToolButtonStyle(Qt.ToolButtonIconOnly)
        self.filter_menu_btn.setAutoRaise(True)

        self.horizontalLayout_2.addWidget(self.filter_menu_btn)

        self.info = QToolButton(self.middle_area_widget)
        self.info.setObjectName(u"info")
        self.info.setMinimumSize(QSize(26, 26))
        icon5 = QIcon()
        icon5.addFile(u":/res/icon_minus.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.thumb_scale.setMaximum(400)
        self.thumb_scale.setValue(100)
        self.thumb_scale.setSliderPosition(100)
        ...
        sizePolicy6.setHeightForWidth(self.details.sizePolicy().hasHeightForWidth())
        self.details.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.details_image.sizePolicy().hasHeightForWidth())
        self.details_image.setSizePolicy(sizePolicy7)
        ...
        self.horizontalLayout.addWidget(self.detail_actions_btn, 0, Qt.AlignBottom)
        ...
        sizePolicy9.setHeightForWidth(self.details_button.sizePolicy().hasHeightForWidth())
        self.details_button.setSizePolicy(sizePolicy9)
        ...
        self.details_button.setArrowType(Qt.DownArrow)

        self.verticalLayout_4.addWidget(self.details_button)
        ...
        self.details_header.setSizePolicy(sizePolicy10)
