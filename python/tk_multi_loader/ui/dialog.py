...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.entity_preset_tabs.setToolTip(QtGui.QApplication.translate("Dialog", "This area shows <i>Flow Production Tracking objects</i> such as Shots or Assets, grouped into sections. ", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.entity_breadcrumbs.setToolTip(QtGui.QApplication.translate("Dialog", "This <i>breadcrumbs listing</i> shows your currently selected Flow Production Tracking location.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.detail_playback_btn.setToolTip(QtGui.QApplication.translate("Dialog", "The most recent published version has some playable media associated. Click this button to launch the Flow Production Tracking <b>Media Center</b> web player to see the review version and any notes and comments that have been submitted.", None, QtGui.QApplication.UnicodeUTF8))
