...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.entity_widget = QtGui.QStackedWidget(self.layoutWidget)
        self.entity_widget.setObjectName("entity_widget")
        self.page = QtGui.QWidget()
        self.page.setObjectName("page")
        self.verticalLayout_7 = QtGui.QVBoxLayout(self.page)
        self.verticalLayout_7.setContentsMargins(1, 1, 1, 1)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.entity_view = QtGui.QTreeView(self.page)
        self.entity_view.setEditTriggers(QtGui.QAbstractItemView.NoEditTriggers)
        self.entity_view.setProperty("showDropIndicator", False)
        self.entity_view.setIconSize(QtCore.QSize(16, 16))
        self.entity_view.setHeaderHidden(True)
        self.entity_view.setObjectName("entity_view")
        self.verticalLayout_7.addWidget(self.entity_view)
        self.entity_widget.addWidget(self.page)
        self.page_2 = QtGui.QWidget()
        self.page_2.setObjectName("page_2")
        self.verticalLayout_11 = QtGui.QVBoxLayout(self.page_2)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.details_list_spinner_3 = QtGui.QLabel(self.page_2)
        self.details_list_spinner_3.setText("")
        self.details_list_spinner_3.setPixmap(QtGui.QPixmap(":/res/progress_bar_1.png"))
        self.details_list_spinner_3.setAlignment(QtCore.Qt.AlignCenter)
        self.details_list_spinner_3.setObjectName("details_list_spinner_3")
        self.verticalLayout_11.addWidget(self.details_list_spinner_3)
        self.entity_widget.addWidget(self.page_2)
        self.verticalLayout.addWidget(self.entity_widget)
        ...
        self.filters_widget = QtGui.QStackedWidget(self.layoutWidget1)
        ...
        self.publish_type_list = QtGui.QListView(self.page_3)
        ...
        self.filters_widget.addWidget(self.page_3)
        self.page_4 = QtGui.QWidget()
        self.page_4.setObjectName("page_4")
        self.verticalLayout_10 = QtGui.QVBoxLayout(self.page_4)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.details_list_spinner_2 = QtGui.QLabel(self.page_4)
        self.details_list_spinner_2.setText("")
        self.details_list_spinner_2.setPixmap(QtGui.QPixmap(":/res/progress_bar_1.png"))
        self.details_list_spinner_2.setAlignment(QtCore.Qt.AlignCenter)
        self.details_list_spinner_2.setObjectName("details_list_spinner_2")
        self.verticalLayout_10.addWidget(self.details_list_spinner_2)
        self.filters_widget.addWidget(self.page_4)
        self.verticalLayout_2.addWidget(self.filters_widget)
        ...
        self.middle_area.addWidget(self.publish_widget)
...
"")
        ...
        self.details_widget = QtGui.QStackedWidget(self.details)
        ...
        self.details_widget.addWidget(self.details_list_page)
        ...
        self.details_widget.addWidget(self.details_list_spinner_page)
        self.verticalLayout_4.addWidget(self.details_widget)
        self.gridLayout.addWidget(self.details, 2, 2, 1, 1)

        self.retranslateUi(Dialog)
        self.entity_widget.setCurrentIndex(0)
        self.filters_widget.setCurrentIndex(0)
        self.publish_widget.setCurrentIndex(0)
        self.details_widget.setCurrentIndex(0)
