...
" }")
        ...
        self.check_supported = QtGui.QToolButton(self.layoutWidget1)
        self.check_supported.setStyleSheet("QToolButton { color: #619DE0; }")
        self.check_supported.setObjectName("check_supported")
        self.horizontalLayout_6.addWidget(self.check_supported)
        self.check_all = QtGui.QToolButton(self.layoutWidget1)
        self.check_all.setObjectName("check_all")
        self.horizontalLayout_6.addWidget(self.check_all)
        self.check_none = QtGui.QToolButton(self.layoutWidget1)
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(QtGui.QApplication.translate("Dialog", "<small>Filter by Publish Type</small>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_3.setText(QtGui.QApplication.translate("Dialog", "<small>Show Types: </small>", None, QtGui.QApplication.UnicodeUTF8))
        self.check_supported.setToolTip(QtGui.QApplication.translate("Dialog", "Clicking the <span style=\'color: #619DE0\'>supported</span> button will check all the types in the type list above that are supported by the current application. After you have pressed this button, when browsing you will only see publishes which can be added to the current scene. ", None, QtGui.QApplication.UnicodeUTF8))
        self.check_supported.setText(QtGui.QApplication.translate("Dialog", "Supported", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.check_all.setText(QtGui.QApplication.translate("Dialog", "All", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.check_none.setText(QtGui.QApplication.translate("Dialog", "None", None, QtGui.QApplication.UnicodeUTF8))
